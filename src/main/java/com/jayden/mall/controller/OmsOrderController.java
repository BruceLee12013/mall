...
import com.jayden.mall.service.OmsOrderService;
...
public class OmsOrderController {
    ...
    public ApiRestResponse list(OmsOrderQueryParam queryParam,
                                @RequestParam(value = "pageSize", defaultValue = "5") Integer pageSize,
                                @RequestParam(value = "pageNum", defaultValue = "1") Integer pageNum) {
        List<OmsOrder> orderList = orderService.list(queryParam, pageSize, pageNum);
        return ApiRestResponse.success(orderList);
    }

    @ApiOperation("批量发货")
    @PostMapping("/update/delivery")
    public ApiRestResponse delivery(@RequestBody List<OmsOrderDeliveryParam> deliveryParamList) {
    ...
    public ApiRestResponse close(@RequestParam("ids") List<Long> ids, @RequestParam String note) {
    ...
    @GetMapping("/{id}")
    public ApiRestResponse detail(@PathVariable Long id) {
        OmsOrderDetail orderDetailResult = orderService.detail(id);
        return ApiRestResponse.success(orderDetailResult);
    }

    @ApiOperation("修改收货人信息")
    @PostMapping("/update/receiverInfo")
    public ApiRestResponse updateReceiverInfo(@RequestBody OmsReceiverInfoParam receiverInfoParam) {
    ...
    public ApiRestResponse updateReceiverInfo(@RequestBody OmsMoneyInfoParam moneyInfoParam) {
    ...
    public ApiRestResponse updateNote(@RequestParam("id") Long id,
