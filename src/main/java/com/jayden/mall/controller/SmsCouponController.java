...
import com.jayden.mall.service.SmsCouponService;
...
public class SmsCouponController {
    ...
    @ApiOperation("添加优惠券")
    @PostMapping("/create")
    public ApiRestResponse add(@RequestBody SmsCouponParam couponParam) {
    ...
    public ApiRestResponse update(@PathVariable Long id,@RequestBody SmsCouponParam couponParam) {
    ...
    public ApiRestResponse list(
        ...
        return ApiRestResponse.success(couponList);
    }
    ...
    public ApiRestResponse getItem(@PathVariable Long id) {
        ...
        return ApiRestResponse.success(couponParam);
    }
}
